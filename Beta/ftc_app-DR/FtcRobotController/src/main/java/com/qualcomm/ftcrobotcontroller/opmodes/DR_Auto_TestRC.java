 ...
 */
public class DR_Auto_TestRC extends DR_Auto_Setup{
    Servo plowLeft;
    Servo plowRight;
    double SCA;
    double SCAdelta;
    ...
    public void loop(){
        ...
        switch (a_state){
            ...
            case 1:
                ...
                if (has_LeftRear_encoder_reached(close1))
                {
            ...
            case 2:
                reset_drive_encoders();
                set_drive_power(-0.5,0.5,-0.5,0.5);
                if (has_RightRear_encoder_reached(turn1))
                {
                    set_drive_power(0.0,0.0,0.0,0.0);
                    sleep(500);
                    a_state++;
            ...
            case 3:
                reset_drive_encoders();
                set_drive_power(0.5,0.5,0.5,0.5);
                if (has_LeftRear_encoder_reached(close2))
                {
                    set_drive_power(0.0,0.0,0.0,0.0);
                    sleep(500);
                    a_state++;
            ...
            case 4:
                reset_drive_encoders();
                set_drive_power(-0.5,0.5,-0.5,0.5);
                if (has_RightRear_encoder_reached(turn2))
                {
                    set_drive_power(0.0,0.0,0.0,0.0);
                    sleep(500);
                    a_state++;
